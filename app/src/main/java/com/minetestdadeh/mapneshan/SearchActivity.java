...
import com.minetestdadeh.mapneshan.adapter.SearchAdapter;
import com.minetestdadeh.mapneshan.model.search.Item;
import com.minetestdadeh.mapneshan.model.search.Location;
import com.minetestdadeh.mapneshan.model.search.NeshanSearch;
import com.minetestdadeh.mapneshan.network.GetDataService;
...
public class SearchActivity extends AppCompatActivity implements SearchAdapter.OnSearchItemListener {
    ...
    private void initViews() {
        ...
        items = new ArrayList<>();
        adapter = new SearchAdapter(items, SearchActivity.this);
        ...
        call.enqueue(new Callback<NeshanSearch>() {
            ...
            public void onResponse(Call<NeshanSearch> call, Response<NeshanSearch> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(SearchActivity.this, "خطا در برقراری ارتباط!", Toast.LENGTH_SHORT).show();
                }
            }
